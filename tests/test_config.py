...
class TestLoadSettingsValid:
    ...
    def test_max_sender_ids_none_when_not_set(self):
            s = _load_settings_with_env(_env())
            assert s.max_sender_ids is None
    
    def test_max_sender_ids_populated_when_set(self):
            s = _load_settings_with_env(_env(MAX_SENDER_IDS="-123,-456"))
            assert s.max_sender_ids == "-123,-456"
    
    def test_max_sender_ids_none_when_empty_string(self):
